        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-9 px-16 lg:px-32">
            ...
            <div className="mt-8 flex justify-center gap-4 flex-wrap">
              <Link href="/dashboard" className="bg-blue-100 text-primary-600 px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-primary-600 hover:text-white transition-colors group">
