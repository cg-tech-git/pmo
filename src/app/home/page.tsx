        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-9 px-16 lg:px-32">
            ...
            <div className="mt-8 flex justify-center gap-4 flex-wrap">
              <Link href="/" className="bg-primary-600 text-white px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-gray-200 hover:text-gray-600 transition-colors group">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-3 h-3">
                  <path fill="white" className="group-hover:fill-gray-600" d="M19,2H5C3.3,2,2,3.3,2,5v14c0,1.7,1.3,3,3,3h14c1.7,0,3-1.3,3-3V5C22,3.3,20.7,2,19,2z M8,17c0,0.6-0.4,1-1,1s-1-0.4-1-1v-4c0-0.6,0.4-1,1-1s1,0.4,1,1V17z M13,17c0,0.6-0.4,1-1,1s-1-0.4-1-1V7c0-0.6,0.4-1,1-1s1,0.4,1,1V17z M18,17c0,0.6-0.4,1-1,1s-1-0.4-1-1v-6c0-0.6,0.4-1,1-1s1,0.4,1,1V17z"></path>
                </svg>
                Dashboard
              </Link>
              <Link href="/processes" className="bg-primary-600 text-white px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-gray-200 hover:text-gray-600 transition-colors group">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-3 h-3">
                  <path fill="white" className="group-hover:fill-gray-600" d="M15,8h4.4L14,2.6V7C14,7.6,14.4,8,15,8z M14.5,19c0-1.2,0.9-2.2,2-2.5c0.2-1.2,1.3-2,2.5-2c0.3,0,0.7,0.1,1,0.2V10h-5c-1.7,0-3-1.3-3-3V2H7C5.3,2,4,3.3,4,5v14c0,1.7,1.3,3,3,3h9.7c-0.1-0.2-0.1-0.4-0.2-0.5C15.4,21.2,14.5,20.2,14.5,19z M8,8h1c0.6,0,1,0.4,1,1s-0.4,1-1,1H8c-0.6,0-1-0.4-1-1S7.4,8,8,8z M11,18H8c-0.6,0-1-0.4-1-1s0.4-1,1-1h3c0.6,0,1,0.4,1,1S11.6,18,11,18z M8,14c-0.6,0-1-0.4-1-1s0.4-1,1-1h6c0.6,0,1,0.4,1,1s-0.4,1-1,1H8z"></path>
                </svg>
                Templates
              </Link>
              <Link href="/projects" className="bg-primary-600 text-white px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-gray-200 hover:text-gray-600 transition-colors group">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-3 h-3">
              ...
              <Link href="/commercial" className="bg-primary-600 text-white px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-gray-200 hover:text-gray-600 transition-colors group">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-3 h-3">
                  <path fill="white" className="group-hover:fill-gray-600" d="M6,6.2V3c0-0.6-0.4-1-1-1S4,2.4,4,3v3.2C2.4,6.7,1.6,8.4,2.2,10c0.3,0.9,1,1.5,1.8,1.8V21c0,0.6,0.4,1,1,1s1-0.4,1-1v-9.2C7.6,11.3,8.4,9.6,7.8,8C7.5,7.2,6.9,6.5,6,6.2z M21.8,10c-0.3-0.9-1-1.5-1.8-1.8V3c0-0.6-0.4-1-1-1s-1,0.4-1,1v5.2c-1.6,0.5-2.4,2.2-1.8,3.8c0.3,0.9,1,1.5,1.8,1.8V21c0,0.6,0.4,1,1,1s1-0.4,1-1v-7.2C21.6,13.3,22.4,11.6,21.8,10z M13,14.2V3c0-0.6-0.4-1-1-1s-1,0.4-1,1v11.2c-1.6,0.5-2.4,2.2-1.8,3.8c0.3,0.9,1,1.5,1.8,1.8V21c0,0.6,0.4,1,1,1s1-0.4,1-1v-1.2c1.6-0.5,2.4-2.2,1.8-3.8C14.5,15.2,13.9,14.5,13,14.2z"></path>
                </svg>
                Commercial
              </Link>
              <Link href="/resources" className="bg-primary-600 text-white px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-gray-200 hover:text-gray-600 transition-colors group">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-3 h-3">
                  <path fill="white" className="group-hover:fill-gray-600" d="M10.7 13.3c-.4-.4-1-.4-1.4 0l-2.8 2.8-2.8-2.8c-.4-.4-1-.4-1.4 0-.4.4-.4 1 0 1.4l2.8 2.8-2.8 2.8c-.4.4-.4 1 0 1.4s1 .4 1.4 0l2.8-2.8 2.8 2.8c.4.4 1 .4 1.4 0 .4-.4.4-1 0-1.4l-2.8-2.8 2.8-2.8c.4-.4.4-1 0-1.4zm2.9-2.4c.1.1.2.1.4.1h7c.6 0 1-.4 1-1 0-.2 0-.3-.1-.4l-3.5-7c-.3-.5-.9-.7-1.4-.4-.1.1-.3.2-.4.4l-3.5 7c-.2.4 0 1 .5 1.3zM6.5 2C4 2 2 4 2 6.5S4 11 6.5 11 11 9 11 6.5 9 2 6.5 2zM21 13h-7c-.6 0-1 .4-1 1v7c0 .6.4 1 1 1h7c.6 0 1-.4 1-1v-7c0-.6-.4-1-1-1z"></path>
                </svg>
                Resources
              </Link>
              <Link href="/reports" className="bg-primary-600 text-white px-3 py-2 rounded-full text-xs font-medium flex items-center gap-1 hover:bg-gray-200 hover:text-gray-600 transition-colors group">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" className="w-3 h-3">
                  <path fill="white" className="group-hover:fill-gray-600" d="M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10s10-4.5,10-10S17.5,2,12,2z M16.2,10.3l-4.9,4.9c-0.4,0.4-1,0.4-1.4,0l-2.1-2.1c-0.4-0.4-0.4-1,0-1.4c0.4-0.4,1-0.4,1.4,0l1.4,1.4l4.2-4.2c0.4-0.4,1-0.4,1.4,0C16.6,9.3,16.6,9.9,16.2,10.3z"></path>
                </svg>
                Reports
              </Link>
            </div>
